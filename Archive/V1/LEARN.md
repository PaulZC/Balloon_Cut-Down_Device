...
[ASSEMBLY.md](https://github.com/PaulZC/Balloon_Cut-Down_Device/tree/master/Archive/V1/ASSEMBLY.md) contains full instructions for the assembly of the PCB and
...
The PLUS and MINUS switches are used to put the device into [Set_Servo](https://github.com/PaulZC/Balloon_Cut-Down_Device/blob/master/Archive/V1/LEARN.md#set_servo)
or [Set_Duration](https://github.com/PaulZC/Balloon_Cut-Down_Device/blob/master/Archive/V1/LEARN.md#set_duration) mode.
...
This will trigger the device if intDuration is set to '0' or '1' (see [Set_Duration](https://github.com/PaulZC/Balloon_Cut-Down_Device/blob/master/Archive/V1/LEARN.md#set_duration)).
...
**SWCLK** and **SWDIO** are used during [programming of the SAMD bootloader](https://github.com/PaulZC/Balloon_Cut-Down_Device/blob/master/Archive/V1/LEARN.md#how-do-i-install-the-atsamd21g18-bootloader).
...
battery is connected. This pin can be used to power the board during [programming of the SAMD bootloader](https://github.com/PaulZC/Balloon_Cut-Down_Device/blob/master/Archive/V1/LEARN.md#how-do-i-install-the-atsamd21g18-bootloader).
